...
#                                iStartAdults = input$iStartAdults)
      ...
      for( day in 2:input$days ) {
        ...
        slopeb <- ((vPop[day]-vPop[day-1])/vPop[day-1])/input$iCarryCap 
        
        #what happens if I just put 1/carrycap in here
        #it doesn't stabilise the pop at all
        #slopeb <- 1/input$iCarryCap        
